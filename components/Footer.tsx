      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          <ul className="flex justify-center gap-6 sm:justify-end">
            <li>
              <Link
                href="https://www.facebook.com/devctbd"
                rel="noreferrer"
                target="_blank"
            ...
            <li>
              <Link
                href="https://www.linkedin.com/in/devctbd/"
                target="_blank"
                rel="noreferrer"
                className="text-teal-700 transition hover:text-teal-700/75 dark:text-teal-500 dark:hover:text-teal-500/75"
              >
          ...
          <div className="mt-16 sm:flex sm:items-center sm:justify-between">
            <p className="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-right dark:text-gray-400">
              Copyright &copy; {new Date().getFullYear()}. Devctbd All rights
              reserved.
            </p>
          </div>
        </div>
